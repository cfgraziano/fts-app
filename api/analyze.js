module.exports = async (req, res) => {
  ...
  try {
    ...
    const prompt = `You are the content strategist for Fill Their Suitcase, a luxury family travel Instagram brand (@filltheirsuitcase). Analyze this image and provide four things:
